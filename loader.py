...
# Paths - use relative paths for deployment compatibility
DATA_DIR = os.getenv("DATA_DIR_PATH", str(Path(__file__).parent / "data"))
CHROMA_DIR = os.getenv("CHROMA_DB_PATH", str(Path(__file__).parent / "chroma"))
