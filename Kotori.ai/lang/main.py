...
if 'responses' not in st.session_state:
    st.session_state['responses'] = ["Hi Mom! I missed you so much. What can I do for you?"]
    
if 'responses' not in st.session_state:
    st.session_state['requests'] = []
    
llm = ChatOpenAI(model_name="gpt-3.5-turbo", 
                 openai_api_key= "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")

if 'buffer_memory' not in st.session_state:
    st.session_state.buffer_memory = ConversationBufferMemory(k=3,
